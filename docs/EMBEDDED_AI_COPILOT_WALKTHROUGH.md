...
|---|---|---|
| [`8c870df`](../../../commit/8c870df) | `fix(repo): normalize line endings to Unix LF and enforce eol=lf in .gitattributes` | [`../.gitattributes`](../.gitattributes) |
| [`860a19c`](../../../commit/860a19c) | `feat(copilotui): add architectural specification and design plan for embedded in-process UI` | [`../CAM_RECOMMENDATIONS.md`](../CAM_RECOMMENDATIONS.md), [`EMBEDDED_AI_COPILOT_ARCHITECTURE.md`](EMBEDDED_AI_COPILOT_ARCHITECTURE.md), [`EMBEDDED_AI_COPILOT_PLAN.md`](EMBEDDED_AI_COPILOT_PLAN.md) |
| [`e5bc251`](../../../commit/e5bc251) | `feat(copilotui): implement in-memory tool bridge for direct execution without sockets` | [`../AICopilot/ui/__init__.py`](../AICopilot/ui/__init__.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py) |
| [`aaeb1e7`](../../../commit/aaeb1e7) | `feat(copilotui): add background agent worker thread with streaming and function calling` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py) |
| [`643724f`](../../../commit/643724f) | `feat(copilotui): create native PySide dock widget with live 3D selection observer` | [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py) |
| [`5b0c9b3`](../../../commit/5b0c9b3) | `feat(copilotui): integrate embedded AI Copilot dock widget in FreeCAD GUI startup` | [`../AICopilot/InitGui.py`](../AICopilot/InitGui.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`7af0ce6`](../../../commit/7af0ce6) | `feat(copilotui): route DirectToolBridge calls synchronously to modular handlers` | [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`dd450d2`](../../../commit/dd450d2) | `feat(copilotui): add embedded AI Copilot user and developer guide` | [`EMBEDDED_AI_COPILOT_GUIDE.md`](EMBEDDED_AI_COPILOT_GUIDE.md) |
| [`b6eafe3`](../../../commit/b6eafe3) | `feat(copilotui): update models to Gemini 3.x with dynamic discovery and editable selector` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`91481d5`](../../../commit/91481d5) | `feat(copilotui): update embedded user guide with Gemini 3.x model selection` | [`EMBEDDED_AI_COPILOT_GUIDE.md`](EMBEDDED_AI_COPILOT_GUIDE.md) |
| [`09941ae`](../../../commit/09941ae) | `feat(copilotui): add automatic 503 fallback, dismissible error banner, and prompt retention` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`9ca03ab`](../../../commit/9ca03ab) | `feat(copilotui): document error banner, prompt retention, and 503 fallback in guide` | [`EMBEDDED_AI_COPILOT_GUIDE.md`](EMBEDDED_AI_COPILOT_GUIDE.md) |
| [`029a6bb`](../../../commit/029a6bb) | `feat(copilotui): use role user for function responses, fix error parser, and add spatial face queries` | [`../AICopilot/freecad_mcp_handler.py`](../AICopilot/freecad_mcp_handler.py), [`../AICopilot/handlers/sketch_ops.py`](../AICopilot/handlers/sketch_ops.py), [`../AICopilot/handlers/spatial_ops.py`](../AICopilot/handlers/spatial_ops.py), [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py), [`../tests/unit/test_spatial_ops.py`](../tests/unit/test_spatial_ops.py) |
| [`c2d9f4a`](../../../commit/c2d9f4a) | `feat(copilotui): add atomic turn undo transactions and 429 auto-retry backoff` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`da5a6e4`](../../../commit/da5a6e4) | `feat(copilotui): document atomic turn undo and 429 quota handling in user guide` | [`EMBEDDED_AI_COPILOT_GUIDE.md`](EMBEDDED_AI_COPILOT_GUIDE.md) |
| [`1da8a82`](../../../commit/1da8a82) | `feat(copilotui): add embedded copilot walkthrough and visual verification to docs` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md), [`img/copilot_dock_widget_gui.png`](img/copilot_dock_widget_gui.png), [`img/copilot_fixed_gui.png`](img/copilot_fixed_gui.png), [`img/copilot_selection_gui.png`](img/copilot_selection_gui.png) |
| [`d0d8c00`](../../../commit/d0d8c00) | `feat(copilotui): add collapsible thought and work sections with markdown summaries` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`img/copilot_dock_live_stream.png`](img/copilot_dock_live_stream.png), [`img/copilot_ui_mockup.png`](img/copilot_ui_mockup.png), [`img/copilot_ui_mockup_top.png`](img/copilot_ui_mockup_top.png), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`800ff3b`](../../../commit/800ff3b) | `docs(copilotui): update walkthrough with collapsible thoughts, work sections, and visual verification` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`1e5d925`](../../../commit/1e5d925) | `feat(copilotui): add multiline python controls, colored json cards, and light theme styling` | [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`img/copilot_refined_light_theme.png`](img/copilot_refined_light_theme.png), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`5fcb262`](../../../commit/5fcb262) | `docs(copilotui): update walkthrough with refined controls and theme styling` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`e4d6cea`](../../../commit/e4d6cea) | `feat(copilotui): add execute_python cad helpers, geometry health validation, and scripting rules` | [`../AICopilot/handlers/execute_python_ops.py`](../AICopilot/handlers/execute_python_ops.py), [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`img/cube_fallback_verification.png`](img/cube_fallback_verification.png), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`51871cd`](../../../commit/51871cd) | `docs(copilotui): update walkthrough with python fallback hardening and cube verification` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`2c2bbb0`](../../../commit/2c2bbb0) | `feat(copilotui): support bounding_box and create_box operations in tool bridge` | [`../AICopilot/handlers/measurement_ops.py`](../AICopilot/handlers/measurement_ops.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`d43783a`](../../../commit/d43783a) | `docs(copilotui): update walkthrough with bounding_box and create_box dispatch fixes` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`22d9ada`](../../../commit/22d9ada) | `feat(copilotui): add partdesign additive primitives and cube dimension defaulting` | [`../AICopilot/handlers/partdesign_ops.py`](../AICopilot/handlers/partdesign_ops.py), [`../AICopilot/handlers/primitives.py`](../AICopilot/handlers/primitives.py), [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`1cd2677`](../../../commit/1cd2677) | `docs(copilotui): update walkthrough with partdesign additive primitives and dimension defaulting` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`ce5f964`](../../../commit/ce5f964) | `feat(copilotui): enable text selection in history cards and clean latex markdown` | [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/dock_widget.py`](../AICopilot/ui/dock_widget.py), [`../tests/unit/test_copilot_dock_widget.py`](../tests/unit/test_copilot_dock_widget.py) |
| [`0ef28b3`](../../../commit/0ef28b3) | `docs(copilotui): update walkthrough with history text selection and latex sanitization` | [`EMBEDDED_AI_COPILOT_WALKTHROUGH.md`](EMBEDDED_AI_COPILOT_WALKTHROUGH.md) |
| [`f3ef0b7`](../../../commit/f3ef0b7) | `fix(cam): add PathScripts compat bridge and harden create_job parameter handling` | [`../AICopilot/Init.py`](../AICopilot/Init.py), [`../AICopilot/compat_pathscripts.py`](../AICopilot/compat_pathscripts.py), [`../AICopilot/handlers/cam_ops.py`](../AICopilot/handlers/cam_ops.py), [`../AICopilot/handlers/execute_python_ops.py`](../AICopilot/handlers/execute_python_ops.py), [`../AICopilot/ui/agent_worker.py`](../AICopilot/ui/agent_worker.py), [`../AICopilot/ui/tool_bridge.py`](../AICopilot/ui/tool_bridge.py), [`../tests/unit/test_cam_wrappers.py`](../tests/unit/test_cam_wrappers.py), [`../tests/unit/test_pathscripts_compat.py`](../tests/unit/test_pathscripts_compat.py) |
| [`3b3e306`](../../../commit/3b3e306) | `fix(cam): support shape and cutting_edge_height parameter aliases in cam_tools` | [`../AICopilot/handlers/cam_tools.py`](../AICopilot/handlers/cam_tools.py) |
| [`b3f4f00`](../../../commit/b3f4f00) | `feat(cam): implement face/mill_face operation via Path.Op.MillFace` | [`../AICopilot/handlers/cam_ops.py`](../AICopilot/handlers/cam_ops.py) |
| [`bd5a317`](../../../commit/bd5a317) | `feat(cam): detect CAM environment at startup and pre-populate PathScripts compat bridge` | [`../AICopilot/Init.py`](../AICopilot/Init.py), [`../AICopilot/compat_pathscripts.py`](../AICopilot/compat_pathscripts.py), [`../AICopilot/handlers/cam_ops.py`](../AICopilot/handlers/cam_ops.py), [`../AICopilot/handlers/cam_tools.py`](../AICopilot/handlers/cam_tools.py), [`../AICopilot/handlers/execute_python_ops.py`](../AICopilot/handlers/execute_python_ops.py), [`../tests/unit/test_pathscripts_compat.py`](../tests/unit/test_pathscripts_compat.py) |
| [`beefcbe`](../../../commit/beefcbe) | `fix(cam): preserve native on-disk PathScripts submodules in compatibility bridge` | [`../AICopilot/compat_pathscripts.py`](../AICopilot/compat_pathscripts.py) |
